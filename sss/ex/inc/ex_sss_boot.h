...
typedef struct
{
    se_sss_session_t platf_session;
    SE_Connect_Ctx_t platf_open_ctx;
    se_sss_session_t *phost_session;
    se_sss_key_store_t *phost_ks;
...
#if SSS_HAVE_APPLET
sss_status_t ex_sss_se_prepare_host(se_sss_session_t *host_session,
    se_sss_key_store_t *host_ks,
    SE_Connect_Ctx_t *se05x_open_ctx,
    ex_SE05x_authCtx_t *ex_se05x_authctx,
    SE_AuthType_t auth_type);
