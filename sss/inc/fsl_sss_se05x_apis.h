 ...
 *
 */
sss_status_t sss_se05x_key_object_set_eccgfp_group(sss_se05x_object_t *keyObject, se_sss_eccgfp_group_t *group);
...
/** @copydoc se_sss_derive_key_one_go
 *
 */
...
/** @copydoc se_sss_derive_key_sobj_one_go
*
*/
...
/** @copydoc se_sss_cipher_one_go_v2
 *
 */
 ...
 * @{
 */
/** @copydoc se_sss_aead_context_init
 *
 */
...
/** @copydoc se_sss_aead_context_free
 *
 */
...
/** Gets the SE05x Digest Mode correspanding to the provided sha algorithm
*
*/
...
#       define se_sss_derive_key_go(context,saltData,saltLen,info,infoLen,derivedKeyObject,deriveDataLen,hkdfOutput,hkdfOutputLen) \
...
#       define se_sss_derive_key_dh(context,otherPartyKeyObject,derivedKeyObject) \
...
#       define se_sss_cipher_one_go(context,iv,ivLen,srcData,destData,dataLen) \
            sss_se05x_cipher_one_go(((sss_se05x_symmetric_t * ) context),(iv),(ivLen),(srcData),(destData),(dataLen))
#       define se_sss_cipher_one_go_v2(context,iv,ivLen,srcData,srcLen,destData,pDataLen) \
            sss_se05x_cipher_one_go_v2(((sss_se05x_symmetric_t * ) context),(iv),(ivLen),(srcData),(srcLen),(destData),(pDataLen))
#       define se_sss_cipher_init(context,iv,ivLen) \
            sss_se05x_cipher_init(((sss_se05x_symmetric_t * ) context),(iv),(ivLen))
#       define se_sss_cipher_update(context,srcData,srcLen,destData,destLen) \
            sss_se05x_cipher_update(((sss_se05x_symmetric_t * ) context),(srcData),(srcLen),(destData),(destLen))
#       define se_sss_cipher_finish(context,srcData,srcLen,destData,destLen) \
            sss_se05x_cipher_finish(((sss_se05x_symmetric_t * ) context),(srcData),(srcLen),(destData),(destLen))
#       define se_sss_cipher_crypt_ctr(context,srcData,destData,size,initialCounter,lastEncryptedCounter,szLeft) \
...
#       define se_sss_symmetric_context_free(context) \
            sss_se05x_symmetric_context_free(((sss_se05x_symmetric_t * ) context))
        /* Direct Call : aead */
#       define se_sss_aead_context_init(context,session,keyObject,algorithm,mode) \
