...
/*LED Remapping for Plug & Trust*/

#define LED_RED_INIT(output)  LED_RED1_INIT(output)
#define LED_RED_ON() LED_RED1_ON()
#define LED_RED_OFF() LED_RED1_OFF()
#define LED_RED_TOGGLE() LED_RED1_TOGGLE()

#define LED_GREEN_INIT(output)  LED_RED2_INIT(output)
#define LED_GREEN_ON()          LED_RED2_ON()
#define LED_GREEN_OFF()         LED_RED2_OFF()
#define LED_GREEN_TOGGLE()      LED_RED2_TOGGLE()
