...
#define PLUGANDTRUST_HOSTLIB_VER_STRING_NUM     "v04.07.04_02"
#define PLUGANDTRUST_HOSTLIB_PROD_NAME_VER_FULL "PlugAndTrust_HostLib_v04.07.04_02"
#define PLUGANDTRUST_HOSTLIB_VER_MAJOR          (4u)
#define PLUGANDTRUST_HOSTLIB_VER_MINOR          (7u)
#define PLUGANDTRUST_HOSTLIB_VER_DEV            (4u)
#define PLUGANDTRUST_MATTER_INTEGRATION_VER     (2u)
